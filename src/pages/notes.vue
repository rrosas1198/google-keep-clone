<template>
    <header class="notes__header container-fluid">
        <VIconButton id="menu" link aria-label="Abrir menú">
            <i class="material-symbols-outlined">menu</i>
        </VIconButton>

        <form id="search" class="notes__search">
            <VIconButton
                id="search-submit"
                class="notes__search-submit"
                aria-label="Buscar"
                type="submit"
            >
        ...
        <VIconButton id="refresh" class="notes__refresh" link aria-label="Actualizar">
        ...
        <VIconButton id="settings" class="notes__settings" link aria-label="Configuración">
